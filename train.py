...
def train(args):
    ...
    #agent=torch.load("/home/airlab1tb/다운로드/ppo_histroy/checkpoints/agent-{}-ppo-seed1-default.pt".format(args.env_name),map_location="cuda:0")
    # Settings
    ...
    checkpoint_path="/home/airlab1tb/다운로드/ppo_histroy/checkpoints/agent-{}-ppo-seed1-default.pt".format(args.env_name)
    print(args.env_name)
