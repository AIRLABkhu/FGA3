...
def main(args):
	...
	work_dir = os.path.join(args.log_dir, args.domain_name + '_' + args.task_name, args.algorithm,
							str(args.seed) + '_' + args.tag)
	...
	agent = torch.load('/home/airlab1tb/FAAG/logs/walker_walk/sac/1111_another_1e5/model/500000.pt')
	agent.train(False)
